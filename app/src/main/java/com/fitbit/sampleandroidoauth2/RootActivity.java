...
public class RootActivity extends AppCompatActivity implements AuthenticationHandler {
    ...
    public void onLoggedIn() {
       ...
       // Intent startServiceIntent = new Intent(this, UserDataActivity.class);
        // startService(startServiceIntent);
               //Added by Ranjan
      //Intent intent2 = MainPageActivity.newIntent(this);
       // startActivity(intent2);
       //startActivity(new Intent(RootActivity.this,MainPageActivity.class));
